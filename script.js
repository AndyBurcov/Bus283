...
const bibleVerses = [
    "«Промовляє до нього Ісус: Я — дорога, і правда, і життя» (Івана 14:6)",
    "«Бо так полюбив Бог світ, що віддав Сина Свого Однородженого» (Івана 3:16)",
    "«Господь — то мій Пастир, тому в недостатку не буду» (Псалом 22:1)",
    "«Все можу в Тім, Хто мене підкріпляє — у Христі Ісусі» (Филип'ян 4:13)",
    "«Бо Я знаю ті думки, які думаю про вас, — говорить Господь» (Єремії 29:11)"
];
